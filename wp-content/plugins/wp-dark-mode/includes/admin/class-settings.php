...
if ( ! class_exists( 'WP_Dark_Mode_Settings' ) ) {
	...
	class WP_Dark_Mode_Settings {
		...
		public function settings_fields() {
			...
			$sections = array(
				...
				array(
					...
					'title' => sprintf(
                        __( '%s <span>Switch Settings</span>', 'wp-dark-mode' ),
				...
				'wp_dark_mode_switch' => apply_filters( 'wp_dark_mode/switch_settings', array(
					...
					'switch_style' => array(
							...
							'options' => [
								...
								'8'  => WP_DARK_MODE_ASSETS . '/images/button-presets/8.png',
		...
		public function switch_preview() {
			...
			return sprintf( '<div class="switch-preview">%s</div>', do_shortcode( "[wp_dark_mode style=$switch_side]" ) );
		}
